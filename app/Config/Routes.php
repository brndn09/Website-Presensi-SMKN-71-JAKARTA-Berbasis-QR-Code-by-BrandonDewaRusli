...
$routes->post('forgot-password/send', 'ForgotPassword::sendOTP');
$routes->get('forgot-password/verify', 'ForgotPassword::verifyView');
$routes->post('forgot-password/reset', 'ForgotPassword::processReset');
...
$routes->group('admin', function (RouteCollection $routes) {
   ...
   // Hapus kata 'admin/' di depannya karena sudah ada di dalam group 'admin'
$routes->post('siswa/kenaikan-kelas', 'Admin\DataSiswa::kenaikanKelasMassal');
   // POST Data Siswa
   ...
   $routes->post('absen-siswa/pkl-massal', 'Admin\DataAbsenSiswa::simpanPklMassal');

   $routes->post('absen-siswa/cetak', '\App\Controllers\Admin\DataAbsenSiswa::cetakPresensiFilter');
   ...
   $routes->post('laporan/siswa_terlambat', 'Admin\GenerateLaporan::generateLaporanTerlambat');
...
$routes->group('teacher', ['namespace' => 'App\Controllers\Teacher', 'filter' => 'login'], function (RouteCollection $routes) {
   ...
   $routes->post('laporan/terlambat', 'Reports::terlambat');
...
// Rute untuk menampilkan halaman form ganti password
// $routes->get('profile', 'Profile::index');

// Rute untuk memproses perubahan password (yang kamu buat tadi)
