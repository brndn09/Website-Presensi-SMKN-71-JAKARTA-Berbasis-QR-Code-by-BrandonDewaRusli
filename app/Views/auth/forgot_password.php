...
<div class="main-panel">
    <div class="d-flex flex-column align-items-center w-100">
        ...
        <div class="card-login">
            ...
            <div class="card-body-login">
                <?php if(session('error')): ?> 
                    <div class="alert alert-danger" style="border-radius: 12px; font-size: 0.85rem; padding: 12px;">
                        <?= session('error') ?>
                    </div> 
                <?php endif; ?>
                <?php if(session('msg')): ?> 
                    <div class="alert alert-success" style="border-radius: 12px; font-size: 0.85rem; padding: 12px;">
                        <?= session('msg') ?>
                    </div> 
                <?php endif; ?>
                ...
                <form action="<?= base_url('forgot-password/send') ?>" method="post">
                    ...
                    <div class="form-group-custom">
                        ...
                        <input type="email" name="email" class="form-control-modern" required placeholder="name@email.com">
                    </div>
                    <button type="submit" class="btn-login-modern">Kirim Kode OTP</button>
                    
                    <div style="text-align: center; margin-top: 20px;">
                        <a href="<?= base_url('login') ?>" style="font-size: 0.85rem; color: #4361ee; text-decoration: none; font-weight: 600;">
        ...
        <div class="login-footer">
            &copy; <?= date('Y') ?> <b>SMKN 71 Jakarta</b>. All Rights Reserved.
        </div>
    </div>
</div>
<?= $this->endSection(); ?>