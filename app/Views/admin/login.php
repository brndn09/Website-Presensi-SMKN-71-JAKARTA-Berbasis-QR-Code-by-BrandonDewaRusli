    ...
    <div class="card-body-login">
        ...
        <form action="<?= url_to('login') ?>" method="post">
            ...
            <div class="form-group-custom">
                ...
                <input type="text" 
                       class="form-control-modern <?= session('errors.login') ? 'is-invalid' : '' ?>" 
                       name="login" 
            ...
            <div class="form-group-custom">
                ...
                <input type="password" name="password" placeholder="••••••••" class="form-control-modern">
                
                <div style="text-align: right; margin-top: 8px;">
                    <a href="<?= url_to('forgot-password') ?>" style="font-size: 0.8rem; color: #4361ee; text-decoration: none; font-weight: 600; display: inline-block; position: relative; z-index: 5;">
                        Lupa Password?
                    </a>
                </div>
            </div>
