          ...
          <div class="card-body mx-5 my-3">
            ...
            <form action="<?= base_url('admin/jurusan/editJurusanPost'); ?>" method="post">
              ...
              <div class="form-group mt-4">
                ...
                <input type="text" id="jurusan" class="form-control <?= invalidFeedback('jurusan') ? 'is-invalid' : ''; ?>" name="jurusan" placeholder="RPL, ANM, DKV" value="<?= old('jurusan') ?? $jurusan->jurusan  ?? '' ?>">
