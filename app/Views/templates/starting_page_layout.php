...
<head>
   ...
   <meta name="theme-color" content="#2db8bd">
   ...
   <style>
      .bg {
         background: url(<?= base_url("assets/img/gedungsekolah.jpg") ?>) center;
         opacity: 0.4;
      ...
      <div class="container-fluid">
         <div class="navbar-wrapper row w-100 mx-0">
            <div class="col-md-6 d-flex justify-content-center justify-content-md-start">
               <p class="navbar-brand my-auto text-center mx-0"><b><?= (string)($title ?? "PRESENSI SISWA SEKOLAH SMKN 71 JAKARTA") ?></b></p>
            </div>
